...
<body>
    <nav>
        <a style="color: white; text-decoration:none; position:relative; top:7px;" href="dashUtama.php"><h2>KomicKuy</h2></a>
        <ul id="menu-list" class="hidden">
            ...
            ?>
            <li >Hi <?php echo $data['nama']; ?> </li>
            <li><a href="../dashboardAdmin/logout.php">Logout</a></li>
        </ul>
    ...
    <div class="card">
        ...
        <div class="konten">
            ...
            ?>
            <a href="../datakomikpdf/Seoul Station Druid.pdf"><button>Baca Sekarang</button></a>
        </div>
        ...
        <div class="konten">
            ...
            ?>
            <a href="../datakomikpdf/Murim Login.pdf"><button>Baca Sekarang</button></a>
        </div>
        ...
        <div class="konten">
            ...
            ?>
            <a href="../datakomikpdf/MookHyang The Origin.pdf"><button>Baca Sekarang</button></a>
        </div>
        <!-- data4 -->
        <div class="konten">
            ...
            <p>Suatu hari ketika berjalan-jalan, dia berniat ingin menolong seseorang yang justru malah membuat nya ditikam oleh seseorang misterius hingga membuat nya mati. Satu-satu penyesalan nya yaitu dia mati tapi masih dalam keadaan bujang. wkwk ada-ada aja nih.
                ...
                ?>
                <a href="../datakomikpdf/Tensei Shitara Slime Datta Ken.pdf"><button>Baca Sekarang</button></a>
        </div>
    </div>
