...
<body>
    ...
    <div class="con">
        ...
        <div id="datauser" class="tabel">
            <h1>Data Komik</h1>
            <p>Note: Hati-Hati Ketika Mau Menghapus Data Komik!</p>
            <table id="tabeluser" width="720" border="1" cellpadding="5" cellspacing="0">
                <tr>
                    ...
                    <th width="30"> Type</th>
                    <th width="30"> Dirilis</th>
                    <th width="30"> File Komik</th>
                ...
                `genre`,`type`,`dirilis`,`filekomik` FROM komik ORDER BY publish_oleh";
                ...
                ?>
                    <tr>
                        ...
                        <td style="font-size: 13px;"><?php echo $data['filekomik']; ?></td>

                        <td class="button">

                        <a href="komikUbah.php?publish_oleh=<?php echo $data['publish_oleh']; ?>"><button class="ubahkomik">Ubah</button></a>

                            <a href="deleteKomik.php?publish_oleh=<?php echo $data['publish_oleh']; ?>">
