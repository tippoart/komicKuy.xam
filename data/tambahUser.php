...
<head>
    ...
    <style>
        * {
        ...
        .con .tabel form table tr td input::placeholder{
            color: black;
        }
        ...
        .con .tabel form table .pass .passlogo{
            display: flex;
           padding: 10px;
           justify-content: center;
           align-items: center;
        }
        .con .tabel form table .pass .passlogo input{
            width:82%;
            margin-left: 20px;
        }
        .con .tabel form table .pass .passlogo i {
            position: relative;
            left: 10px;
            font-size: 23px;
        ...
        .con .tabel form table .pass .passlogo i:hover{
            transform: scale(1.1);
        }
        .con .tabel form table .pass .passlogo #hidePass{
            display: none;
        }
            ...
            <form method="post" action="tambahUser.php">
                <table cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                        <td>Nama User</td>
                        <td>
                            <input type="text" name="nama" placeholder="masukkan nama lengkap user...">
                        </td>
                    </tr>
                    <tr>
                        <td>Username</td>
                        <td>
                            <input name="username" class="username" type="text" placeholder="Masukkan Username Baru...">
                    ...
                    <tr>
                        <td>Email</td>
                        <td>
                            <input type="email" name="email" placeholder="masukkan email user...">
                        </td>
                    </tr>
                    <tr class="pass">
                        <td>Password</td>
                        <td class="passlogo">
                            <input id="pass" type="password" name="pass" placeholder="Masukkan Password user...">
                ...
                <p>Note: Hohon Periksa Data user Dengan Benar!</p>
            </form>
        </div>
    </div>
